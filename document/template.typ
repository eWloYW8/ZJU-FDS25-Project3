...
#let project(
  ...
  if (theme == "lab") {
    ...
    v(2fr)
    pagebreak()
  } else if (theme == "project" and style == "default") {
    v(1fr)
    box(
      width: 100%,
      {
    ...
    v(4fr)
    pagebreak()
  } else if (theme == "project" and style == "modified") {
    v(3fr)
    box(
      width: 100%,
      {
        ...
        par(leading: 1.5em, text(size: title_size, weight: 700, title))
        ...
        if cover_comments == none {
          text(cover_comments_size)[
            ...
            #par(text(size: 1.2em, weight: 600, "Date: " + date))
